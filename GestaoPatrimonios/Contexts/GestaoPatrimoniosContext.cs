...
public partial class GestaoPatrimoniosContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AreaID).HasName("PK__Area__70B820287A21AE61");

            entity.HasIndex(e => e.NomeArea, "UQ__Area__9A779760D827AC86").IsUnique();
        ...
        {
            entity.HasKey(e => e.BairroID).HasName("PK__Bairro__4A093623D6FD87E1");
        ...
        {
            entity.HasKey(e => e.CargoID).HasName("PK__Cargo__B4E665EDA51557EF");

            entity.HasIndex(e => e.NomeCargo, "UQ__Cargo__4D9FD7DE2463B2DB").IsUnique();
        ...
        {
            entity.HasKey(e => e.CidadeID).HasName("PK__Cidade__B6800959182AE864");
        ...
        {
            entity.HasKey(e => e.EnderecoID).HasName("PK__Endereco__B9D9462F40D3D750");
        ...
        {
            entity.HasKey(e => e.LocalizacaoID).HasName("PK__Localiza__83ABDECA88B75A74");

            entity.ToTable(tb => tb.HasTrigger("trg_Local_SoftDelete"));

            entity.HasIndex(e => e.NomeLocal, "UQ__Localiza__C6ECE727898CE00F").IsUnique();
        ...
        {
            entity.HasKey(e => e.LogPatrimonioID).HasName("PK__LogPatri__E716D12B049002C6");
        ...
        {
            entity.HasKey(e => e.PatrimonioID).HasName("PK__Patrimon__C5A60BDE97AF3F7A");

            entity.ToTable(tb => tb.HasTrigger("trg_Patrimonio_SoftDelete"));

            entity.HasIndex(e => e.NumeroPatrimonio, "UQ__Patrimon__3BC8B35D91EB5849").IsUnique();
        ...
        {
            entity.HasKey(e => e.TransferenciaID).HasName("PK__Solicita__E5B4F5F2E5220286");
        ...
        {
            entity.HasKey(e => e.StatusPatrimonioID).HasName("PK__StatusPa__B3F33609724BBF55");

            entity.HasIndex(e => e.NomeStatus, "UQ__StatusPa__C5C60F1A62EAE032").IsUnique();
        ...
        {
            entity.HasKey(e => e.StatusTransferenciaID).HasName("PK__StatusTr__7AA828B909FCCDA3");

            entity.HasIndex(e => e.NomeStatus, "UQ__StatusTr__C5C60F1A160F63E3").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoAlteracaoID).HasName("PK__TipoAlte__9BEF4F0DC8E596FA");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoAlte__7859A10A326AE2B3").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoPatrimonioID).HasName("PK__TipoPatr__4DC9FF99F3C8F009");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoPatr__7859A10A2B0E9034").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoUsuarioID).HasName("PK__TipoUsua__7F22C70208646614");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoUsua__7859A10A3E7D0ED6").IsUnique();
        ...
        {
            entity.HasKey(e => e.UsuarioID).HasName("PK__Usuario__2B3DE7984B67F71A");

            entity.ToTable(tb => tb.HasTrigger("trg_Usuario_SoftDelete"));

            entity.HasIndex(e => e.RG, "UQ__Usuario__321537C8A84A0369").IsUnique();

            entity.HasIndex(e => e.CarteiraTrabalho, "UQ__Usuario__6E25BCA29C9F1768").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D1053403069E02").IsUnique();

            entity.HasIndex(e => e.CPF, "UQ__Usuario__C1F897319E05430C").IsUnique();

            entity.HasIndex(e => e.NIF, "UQ__Usuario__C7DEC3308CD9EBD5").IsUnique();
            ...
            entity.HasMany(d => d.Localizacao).WithMany(p => p.Usuario)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("UsuarioID", "LocalizacaoID").HasName("PK_LocalUsuario");
                    });
        });
